  ...
  return (
    <div className="about-container">
      ...
      <p className="about-description">
        ...
        compradores de toda Latino América. Ofrecemos garantía y seguridad en la
        compra.
      </p>
      ...
      <ul className="about-faq-list">
        <li className="about-faq-item">
          ...
          <p className="about-faq-answer">
            ...
            compra. Si han transcurrido 30 días desde tu compra, no se te
            ofrecerá un reembolso y/o cambio de ningún tipo. Elegibilidad para
            reembolsos y cambios Tu artículo debe estar sin usar y en las mismas
            condiciones en que lo recibió. El artículo debe estar en el embalaje
            original. Para completar tu devolución, requerimos un recibo o
            comprobante de compra. Solo se pueden reembolsar los artículos de
            precio regular; los artículos de venta no se pueden reembolsar. Si
            el artículo en cuestión fue marcado como un regalo cuando fue
            comprado y se envió directamente a ti, recibirás un crédito de
            regalo por el valor de tu devolución. Cambios (si es aplicable) Solo
            reemplazamos los artículos si están defectuosos o dañados. Si
            necesitas cambiarlo por el mismo artículo, envíanos un email a
            (Agrega dirección de correo electrónico relevante) y envía tu
            artículo a: (Dirección relevante).
          </p>
        </li>
        <li className="about-faq-item">
          <h3 className="about-faq-question">
      ...
      <h2 className="about-subscribe-title">Suscribete a nuestro Newsletter</h2>
      <div />{" "}
    </div>
  );
}
